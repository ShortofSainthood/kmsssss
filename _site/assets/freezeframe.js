!(function (t, e) {
    ...
    return (function (t) {
                            ...
                            return (function (t, e) {
                                ...
                                function s(t, e, a) {
                                    ...
                                    ("string" == typeof t && (l = document.querySelectorAll(t)), l)
                                        ? ((this.elements = ((c = l), Array.isArray(c) ? c : "object" == typeof c && "number" == typeof c.length ? o.call(c) : [c])),
        ...
        function (t, e, n) {
                ...
                l = (t, e, n) => {
                    ...
                    return Array.from(i).reduce((t, e) => {
                        if (e instanceof HTMLImageElement)
                            t.push(e),
                                "gif" !== ((t) => t.split(".").pop().toLowerCase().substring(0, 3))(e.src) &&
                                    n.warnings &&
                                    ((t, ...e) => {
                                        console.warn(s(t), ...e);
            ...
            var h,
                ...
                p = ((h = ["", ""]), (f = ["", ""]), Object.freeze(Object.defineProperties(h, { raw: { value: Object.freeze(f) } })));
            function g(t, e) {
                        ...
                        return (
                            ...
                            (this.tag = function (t) {
                                ...
                                return "function" == typeof t
                                    ...
                                    : ((t = t.map(e.transformString.bind(e))), e.transformEndResult(t.reduce(e.processSubstitutions.bind(e, i))));
                            }),
            ...
            var b = function () {
                ...
                E = (new I(w({ separator: "," }), b, v), new I(w({ separator: ",", conjunction: "and" }), b, v), new I(w({ separator: ",", conjunction: "or" }), b, v), new I(G("\n"), P, w, b, v));
            new I(G("\n"), w, b, v, j(/&/g, "&amp;"), j(/</g, "&lt;"), j(/>/g, "&gt;"), j(/"/g, "&quot;"), j(/'/g, "&#x27;"), j(/`/g, "&#x60;")),
                new I(Z(/(?:\n(?:\s*))+/g, " "), v),
                new I(Z(/(?:\n\s*)/g, ""), v),
            ...
            const R = ".freezeframe",
                ...
                z = "ff-responsive",
                M = "ff-overlay",
                H = { selector: R, responsive: !0, trigger: "hover", overlay: !1, warnings: !0 };
            var T = n(1),
                X = n.n(T);
            var V,
                N,
            ...
            e.default = class {
                constructor(t = R, e) {
                    (this.items = []),
                        ...
                        C.set(this, []),
                        "string" == typeof t || t instanceof Element || t instanceof HTMLCollection || t instanceof NodeList
                            ? ((this.options = Object.assign(Object.assign({}, H), e)), O(this, V, t))
                            : "object" != typeof t || e
                            ? a("Invalid Freezeframe.js configuration:", ...[t, e].filter((t) => void 0 !== t))
                            : ((this.options = Object.assign(Object.assign({}, H), t)), O(this, V, this.options.selector)),
                        this._init(D(this, V));
                }
                get _stylesInjected() {
  ...
  `)
                ...
                _addEventListener(t, e, n) {
                    D(this, C).push({ $image: t, event: e, listener: n }), t.addEventListener(e, n);
                }
