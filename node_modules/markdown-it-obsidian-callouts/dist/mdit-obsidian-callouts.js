...
function k(t, n, i, o) {
  ...
  if (!e.info)
    return "";
  const c = e.info.replace(o.langPrefix || "", "").match(v);
  if (c) {
    e.type = "admonition_block", e.attrPush(["class", "callout"]), e.attrPush(["data-callout", c[1].toLowerCase()]);
...
`);
    for (; a.length > 0 && h.test(a[0]); ) {
      ...
      if (r) {
        ...
        s && e.attrPush([s, r[2].trim()]), a = a.slice(1);
      } else
        break;
    }
    e.content = i.render(a.join(`
`), {});
  }
}
function x(t, n) {
  ...
  for (let r = n; r < t.length; r++) {
    const s = t[r];
    if (s.type === "blockquote_open" ? o++ : s.type === "blockquote_close" && (e = r, o--), o === 0)
      break;
    if (o > 1)
      continue;
...
`);
  ...
  if (a && n !== e) {
    ...
    t[n].type = "callout_open", t[n].attrPush(["class", "callout"]), t[n].attrPush(["data-callout", r]), t[n].attrPush(["data-callout-fold", s]), d && t[n].attrPush(["data-callout-title", d]), t[e].type = "callout_close", t[e].attrPush(["data-callout", r]), t[e].attrPush(["data-callout-fold", s]), c !== n && t[c] && t[c].children && (t[c].content = t[c].content.replace(u, "").trim());
  }
}
function w(t, n, i = {}) {
  const o = t.attrGet("data-callout"), e = t.attrGet("data-callout-fold");
  return o && e ? `
...
function m(t, n = {}) {
  const i = t.attrGet("data-callout"), o = t.attrGet("data-callout-fold");
  return i && o ? "</div></details>" : i ? "</div></div>" : "";
}
function p(t, n = {}) {
  var e;
  ...
  if (i)
    return i.trim();
  const o = t.attrGet("data-callout");
  return o ? ((e = n.icons) == null ? void 0 : e[o]) || l[o] || l.note : "";
}
function g(t, n) {
...
function C(t, n = {}) {
  t.core.ruler.after("block", "obsidian-callouts", (i) => {
    ...
    for (let e = 0; e < o.length; e++) {
      const c = o[e];
      c.type === "blockquote_open" && x(o, e), c.type === "fence" && k(o, e, t, n);
    }
  }), t.renderer.rules.callout_open = (i, o) => {
    const e = i[o];
    return w(e, t, n);
  }, t.renderer.rules.admonition_block = (i, o) => {
    const e = i[o];
    return `${w(e, t, n)}${e.content}
</div>
</div>`;
  }, t.renderer.rules.callout_close = (i, o) => {
    const e = i[o];
    return m(e, n);
  };
}
